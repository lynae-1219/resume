...
\resumeSubheading
{FPGA Hardware Engineering Intern}{Apr -- Sept 2025}
{IMC Trading}{}
\resumeItemListStart
\resumeItem{}
\resumeItemListEnd
...
\resumeSubheading
{3D Gaussian Splatting Quantisation and Acceleration Hardware Research}{Jul -- Sept 2024}
...
\resumeProjectHeading
{\textbf{ICHack25 JetBrains Challenge - 1st Place} \href{https://devpost.com/software/race2code}{\scalebox{0.75}\faLink} $|$ \emph{Python, Typescript, React}}{Feb 2025}
\resumeItemListStart
\resumeItem{Created Race2Code, an interactive game with a no-code approach to learning programming}
\resumeItem{Contributed an interactive conversational AI-powered talkbot which breaks down and explains uploaded code segments to the user}
\resumeItemListEnd
...
\begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Technologies}{: CUDA, OpenGL, PyTorch, Git, Verilator, cocotb, ROS 2, NumPy, OpenCV, React, NGINX, Conda} \\
